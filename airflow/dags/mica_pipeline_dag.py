...
def build_docker_command(**context):
    ...
    bids_dir = conf.get('bids_dir', '/private/hysuh/07-pipeline/data/bids')
    output_dir = conf.get('output_dir', '/private/hysuh/07-pipeline/data/derivatives')
    fs_licence = conf.get('fs_licence', '/private/hysuh/07-pipeline/data/license.txt')
